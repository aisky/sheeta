        ...
        <div class="row">
            <div class="col-sm-12">
            	<span class="aux-text hidden-xs">
                    欢迎来到盈波网: 最纯粹的体育推荐网站，这里是你盈利的开始。随时联系我们:cs@yball.co 电话： +86 138 0000 1111
                </span>
            	<nav class="top-header-menu">
                    <ul class="menu">
                        <li><a href="sign-in.html">登录</a></li>
                        <li class="aux-languages dropdown animate-hover" data-animate="animated fadeInUp"><a href="#"><span class="language name">简体</span></a>
                            <ul id="auxLanguages" class="sub-menu animate-wr">
                                <li><a href="#"><span class="language">繁体</span></a></li>
